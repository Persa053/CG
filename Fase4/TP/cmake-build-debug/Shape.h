...
public:
    ...
    void setSpecular(GLfloat* ambient) {
        this->specular[0] = ambient[0];
        this->specular[1] = ambient[1];
        this->specular[2] = ambient[2];
        this->specular[3] = ambient[3];
    };

    void setDiffuse(GLfloat* ambient) {
        this->diffuse[0] = ambient[0];
        this->diffuse[1] = ambient[1];
        this->diffuse[2] = ambient[2];
        this->diffuse[3] = ambient[3];
    };

    void setEmissive(GLfloat* ambient) {
        this->emissive[0] = ambient[0];
        this->emissive[1] = ambient[1];
        this->emissive[2] = ambient[2];
        this->emissive[3] = ambient[3];
    };


    void setShininess(GLfloat* shininess) {this->shininess[0] = shininess[0];};
